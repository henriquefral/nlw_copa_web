    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <form onSubmit={createPoll} className="mt-10 flex gap-2">
          ...
          />
          <button 
            className="bg-yellow-500 px-6 py-6 rounded text-gray-900 font-bold text-sm uppercase hover:bg-yellow-700"
            type="submit"
          >
            Criar meu bolão
          </button>
...
//Chamadas que precisam ser executadas antes da página carregar no navegador.
